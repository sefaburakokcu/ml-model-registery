...
def model_register(db):
    ...
    version_info = round(model_version, 1)
...
if __name__ == "__main__":
    REGISTERERS = ["burakokcu", "aselsan"]
    registerer_mail = "burakokcu@aselsan.com.tr"
    registerer = registerer_mail.split("@")[0]

    db_name = "db_models"
    index_name = "db_aselsan"
